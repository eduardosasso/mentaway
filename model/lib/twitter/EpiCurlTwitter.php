...
class EpiCurlTwitter
{
  ...
  public function addEasyCurl($ch)
  {
    ...
    $this->startTimer($key);
    return new EpiCurlManagerTwitter($key);
  }
...
class EpiCurlManagerTwitter
{
  ...
  {
    $this->key = $key;
    $this->epiCurl = EpiCurlTwitter::getInstance();
  }
