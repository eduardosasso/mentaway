...
class EpiOAuthTwitter
{
  ...
  public function getAccessToken($params = null)
  {
    ...
    return new EpiOAuthResponseTwitter($resp);
  }
  ...
  public function __construct($consumerKey, $consumerSecret, $signatureMethod='HMAC-SHA1')
  {
    ...
    $this->curl = EpiCurlTwitter::getInstance();
  }
}

class EpiOAuthResponseTwitter
{
  private $__resp;
  protected $debug = false;
  ...
  public function __get($name)
  {
    if($this->__resp->code != 200)
      EpiOAuthExceptionTwitter::raise($this->__resp, $this->debug);
...
class EpiOAuthExceptionTwitter extends Exception
{
  public static function raise($response, $debug)
  {
    ...
    {
      case 400:
        throw new EpiOAuthBadRequestExceptionTwitter($message, $response->code);
      case 401:
        throw new EpiOAuthUnauthorizedExceptionTwitter($message, $response->code);
      default:
        throw new EpiOAuthExceptionTwitter($message, $response->code);
    }
  }
}
class EpiOAuthBadRequestExceptionTwitter extends EpiOAuthExceptionTwitter{}
class EpiOAuthUnauthorizedExceptionTwitter extends EpiOAuthExceptionTwitter{}
